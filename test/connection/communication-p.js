...
describe('Communication passive', () => {
	...
	it('remote entity should recv list of our data messages (does not expect a reply)', function (done) {
		this.timeout( 5000 );
	...
	it('remote entity should recv list of our data messages with small delays (does not expect a reply)', function (done) {
